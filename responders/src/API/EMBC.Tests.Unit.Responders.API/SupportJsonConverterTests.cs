    ...
    public class SupportJsonConverterTests
    {
        ...
        public void CanSerializeSupport()
        {
            ...
            var supports = new Support[]
            {
              ...
              new FoodGroceriesSupport { Id = "3", From = DateTime.Now, To = DateTime.Now.AddDays(3), SupportDelivery = new Referral{ IssuedToPersonName = "person 1", SupplierId = "1", SupplierName = "sup 1", SupplierAddress = supplierAddress }, Status = SupportStatus.UnderReview },
