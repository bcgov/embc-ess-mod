    ...
    public class SupportJsonConverterTests
    {
        ...
        public void CanSerializeSupport()
        {
            ...
            var supports = new Support[]
            {
              ...
              new ShelterAllowanceSupport { Id = "11", From = DateTime.Now, To = DateTime.Now.AddDays(3), SupportDelivery = new Referral{ IssuedToPersonName = "person 4", SupplierId = "4", SupplierName = "sup 4", SupplierAddress = supplierAddress }, Status = SupportStatus.Active },
