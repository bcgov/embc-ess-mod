    ...
    public class SuppliersMapping : Profile
    {
        public SuppliersMapping()
        {
            CreateMap<ESS.Shared.Contracts.Teams.Supplier, SupplierListItem>()
                ...
                .ForMember(d => d.IsPrimarySupplier, opts => opts.MapFrom((s, dst, arg, context) => context.Items.ContainsKey("UserTeamId") && s.Team != null && context.Items["UserTeamId"].Equals(s.Team.Id)))
                .ForMember(d => d.ProvidesMutualAid, opts => opts.MapFrom((s, dst, arg, context) => context.Items.ContainsKey("UserTeamId") && s.Team != null && context.Items["UserTeamId"].Equals(s.Team.Id) && s.SharedWithTeams.Any()))
                ;
