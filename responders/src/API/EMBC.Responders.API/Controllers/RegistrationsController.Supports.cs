...
public abstract record SupportSummary
{
...
public record ReferralSummary : SupportSummary
{
    public string? ManualReferralId { get; set; }
}

public record ETransferSummary : SupportSummary
{
}

public record ProcessDigitalSupportsRequest
{
    public bool IncludeSummaryInPrintRequest { get; set; }
    public IEnumerable<Support> Supports { get; set; }
}

public record ProcessPaperReferralsRequest
{
...
public record ReferralPrintRequestResponse
{
