...
public record EvacuationFileSummary
{
    public string Id { get; set; } = null!;
    public string? ManualFileId { get; set; }
    public EvacuationFileStatus Status { get; set; }
...
public record EvacuationFileTask
{
    [Required]
...
public record EvacuationFileTaskFeature
{
...
public record EvacuationFileNotesResult
{
    public string Id { get; set; } = null!;
}

public record EvacuationFileHouseholdMember
{
    public string? Id { get; set; }
...
public record GetSecurityPhraseResponse
{
    public string SecurityPhrase { get; set; } = null!;
}

public record VerifySecurityPhraseRequest
{
    [Required]
    public string Answer { get; set; }
}

public record VerifySecurityPhraseResponse
{
...
public record RegistrantLinkRequest
{
    [Required]
