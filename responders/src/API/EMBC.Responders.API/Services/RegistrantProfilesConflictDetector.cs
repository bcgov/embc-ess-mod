...
{
    public static class RegistrantProfilesConflictDetector
    {
        public static IEnumerable<ProfileDataConflict> DetectConflicts(RegistrantProfile source, RegistrantProfile target)
        {
        ...
        private static bool AddressEquals(this Address address, Address other) =>
            ...
            address.CommunityCode.StringSafeEquals(other?.CommunityCode) &&
            address.StateProvinceCode.StringSafeEquals(other?.StateProvinceCode) &&
            address.CountryCode.StringSafeEquals(other?.CountryCode));
