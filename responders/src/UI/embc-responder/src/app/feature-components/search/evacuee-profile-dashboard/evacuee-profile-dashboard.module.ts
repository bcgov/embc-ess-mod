...
@NgModule({
    imports: [CommonModule, EvacueeProfileDashboardRoutingModule, MaterialModule, SharedModule, CustomPipeModule, EvacueeProfileDashboardComponent, MatchedEssfilesComponent, PossibleMatchedEssfilesComponent]
})
