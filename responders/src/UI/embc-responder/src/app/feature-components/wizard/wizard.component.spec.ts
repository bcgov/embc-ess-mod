...
describe('WizardComponent-Test for New Registration', () => {
  ...
  it('should load NEW-REGISTRATION menu from compute wizard service', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
  ...
  it('should load EDIT-REGISTRATION menu', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
  ...
  it('should navigate to STEP 1- Edit Evacuee Profile', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
    component.sideNavMenu = wizardDataService.editProfileMenu;
    fixture.detectChanges();
  ...
  it('should navigate to STEP 1- Create ESS File', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
    component.sideNavMenu = wizardDataService.newESSFileMenu;
    fixture.detectChanges();
    component.ngOnInit();
  ...
  it('should load MEMBER-REGISTRATION menu', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
  ...
  it('should navigate to STEP 1- Evacuee Profile', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
    component.sideNavMenu = wizardDataService.newRegistrationMenu;
    wizardService.menuItems = wizardDataService.newRegistrationMenu;
    fixture.detectChanges();
  ...
  it('should open exit modal window on click Exit wizard button', inject([Router], (router: Router) => {
    spyOn(router, 'navigate').and.stub();
