...
describe('EnvironmentBannerComponent', () => {
  ...
  it('should display environment Name', () => {
    ...
    expect(component.environment.envName).toContain(envBannerService.getEnvironmentBanner().envName);
  });
  ...
  it('should display environment title', () => {
    ...
    expect(component.environment.bannerTitle).toContain(envBannerService.getEnvironmentBanner().bannerTitle);
  });
  ...
  it('should display environment subtitle', () => {
    ...
    expect(component.environment.bannerSubTitle).toContain(envBannerService.getEnvironmentBanner().bannerSubTitle);
  });
  ...
  it('should display environment color', () => {
    ...
    expect(component.environment.bannerColor).toContain(envBannerService.getEnvironmentBanner().bannerColor);
  });
});
