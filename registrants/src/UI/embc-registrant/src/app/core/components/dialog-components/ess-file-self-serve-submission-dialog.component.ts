...
@Component({
  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <p>
        3. <b>Support Contact:</b> While most e-Transfers are processed immediately, there are instances where
        processing delays can occur. If your e-Transfer is not received within 24 hours, please contact <br />
        <a>1-800-585-9559</a>.
      </p>
      <p>
...
export class EssFileSelfServeSubmissionDialogComponent {
