    ...
    public class Mappings : Profile
    {
        public Mappings()
        {
            ...
            CreateMap<Supplier, era_supplier>(MemberList.None)
                ...
                .ForMember(d => d.statuscode, opts => opts.MapFrom(s => s.Verified ? SupplierVerificationStatus.Verified : SupplierVerificationStatus.NotVerified))
            ...
            CreateMap<Supplier, era_suppliercontact>(MemberList.None)
                .ForMember(d => d.era_suppliercontactid, opts => opts.MapFrom(s => s.Contact.Id))
                .ForMember(d => d.era_firstname, opts => opts.MapFrom(s => s.Contact.FirstName))
                .ForMember(d => d.era_lastname, opts => opts.MapFrom(s => s.Contact.LastName))
                .ForMember(d => d.era_homephone, opts => opts.MapFrom(s => s.Contact.Phone))
                .ForMember(d => d.emailaddress, opts => opts.MapFrom(s => s.Contact.Email))
            ;
