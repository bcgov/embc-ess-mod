    ...
    public class Mappings : Profile
    {
        public Mappings()
        {
            CreateMap<era_essteamsupplier, TeamSupplier>()
                ...
                .ForPath(d => d.Supplier.Contact.Id, opts => opts.MapFrom(s => s.era_SupplierId._era_primarycontact_value))
                .ForPath(d => d.Supplier.Contact.FirstName, opts => opts.MapFrom(s => s.era_SupplierId.era_PrimaryContact != null ? s.era_SupplierId.era_PrimaryContact.era_firstname : null))
                .ForPath(d => d.Supplier.Contact.LastName, opts => opts.MapFrom(s => s.era_SupplierId.era_PrimaryContact != null ? s.era_SupplierId.era_PrimaryContact.era_lastname : null))
                .ForPath(d => d.Supplier.Contact.Phone, opts => opts.MapFrom(s => s.era_SupplierId.era_PrimaryContact != null ? s.era_SupplierId.era_PrimaryContact.era_homephone : null))
                .ForPath(d => d.Supplier.Contact.Email, opts => opts.MapFrom(s => s.era_SupplierId.era_PrimaryContact != null ? s.era_SupplierId.era_PrimaryContact.emailaddress : null))
