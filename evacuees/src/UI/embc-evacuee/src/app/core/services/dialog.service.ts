  ...
  dateOfBirthMismatch(eraDob: string, bcscDob: string): void {
    this.dialog.open(DialogComponent, {
      data: {
        ...
        body:
          '<div class="row"><p>The date of birth attached to your BC Services card <b>does not match</b> the date of birth associated with your ERA Profile. By clicking <span class="highlight">Continue</span> your details in your ERA Profile will be updated to match the details associated with your BC Services card.</p></div><br><div class="row justify-content-between"><div class="highlight-conflicts">Evacuee Registration & Assistance (ERA)</div><div class="highlight">BC Services Card</div></div><div class="row justify-content-between"><div>' +
          eraDob +
          '</div><div>' +
          bcscDob +
          '</div></div>',
