...
import { RegistrationApiService } from '../api/registrationApi.service';
...
export class ProfileMappingService {
    ...
    constructor(
        private formCreationService: FormCreationService, private dataService: DataService, private cacheService: CacheService) { }
