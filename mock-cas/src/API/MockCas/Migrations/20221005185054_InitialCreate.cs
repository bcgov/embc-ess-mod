        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceCreationDateVal = table.Column<DateTime>(type: "TEXT", nullable: true),
                    ...
                    PaymentStatusDateVal = table.Column<DateTime>(type: "TEXT", nullable: true),
                    Cleareddate = table.Column<string>(type: "TEXT", nullable: true),
                    ClearedDateVal = table.Column<DateTime>(type: "TEXT", nullable: true),
                    voiddate = table.Column<string>(type: "TEXT", nullable: true),
                    VoidDateVal = table.Column<DateTime>(type: "TEXT", nullable: true),
