...
export const deleteRefferalMsg = '<p>Are you sure you want to <b>remove this referral?</b></p><p>You will lose all the information you have entered.</p>';
...
=======
export const invalidFileNameMessage = "File name must not contain the following characters: ~ \" . # % & * : < > ? / \ { | }. Leading and trailing spaces are not allowed.";
>>>>>>> 2871f04c0d73cd160a7a96a4032b335944a7ed4d
